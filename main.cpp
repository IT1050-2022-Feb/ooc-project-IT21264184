...
int main()
{
  ...
  User* us1 = new user("Nimal", "sanka123", "0776783233", "Nimal@gmail.com");
  User* us1 = new user("Shanaka", "gihan1234", "0759876342", "Shanaka@gmail.com");
  ...
  Resources* res1= new Resources("re2","Training and development presentation slides");
  Resources* res1= new Resources("re3","Career path planing presentation slides");

  Manager* mng1= new Manager("mang1","B.M.W.Rathanayake","Accounts Department");
  Manager* mng1= new Manager("mang1","K.S.Karunarathne","Stores Department");
  Manager* mng1= new Manager("mang1","K.T.M.Basnayake","Correspondence Department");
